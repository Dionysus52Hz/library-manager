   ...
   <div>
      ...
      >
         ...
         <template v-slot:prepend>
            ...
            <v-tabs v-model="tab" align-tabs="center" class="d-none d-md-block">
               <v-tab
      ...
      >
         <v-card>
            ...
            <v-list density="compact" mandatory bg-color="#f6f9fb">
               <v-list-item
               ...
               >
                  <template v-slot:prepend>
                     <v-icon :icon="page.icon" color="primary"></v-icon>
                  </template>
...
const pages = [
   ...
   },
   {
      ...
      direct: () => {
         router.push({ name: 'bookCategoriesPage' });
      },
   },
